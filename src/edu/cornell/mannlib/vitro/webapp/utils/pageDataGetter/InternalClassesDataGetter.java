...
/**
 * This will pass these variables to the template: classGroupUri: uri of the
 * classgroup associated with this page. vClassGroup: a data structure that is
 * the classgroup associated with this page.
 */
