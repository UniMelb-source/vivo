 ...
 * The primary page, ManageWebpagesForIndividual, should forward to this page
 * if: (a) we are adding a new page, or (b) an edit link in the Manage Webpages
 * view has been clicked. But right now (a) is not implemented.  *
 * Object properties: core:webpage (range: core:URLLink) core:webpageOf (domain:
 * core:URLLink) (inverse of core:webpage)
 *
 * Class: core:URLLink - the link to be added to the individual
 *
 * Data properties of core:URLLink: core:linkURI core:linkAnchorText core:rank
 *
 */
