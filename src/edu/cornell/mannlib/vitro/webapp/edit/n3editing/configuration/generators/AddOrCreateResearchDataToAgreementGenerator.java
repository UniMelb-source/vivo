 ...
 * @author tsullivan
 */
public class AddOrCreateResearchDataToAgreementGenerator extends AddOrCreateGenerator {

    private static final String template = "addOrCreateResearchData.ftl";
    private static final String subjectName = "agreement";
    private static final String predicateName = "predicate";
    private static final String objectName = "researchDataUri";
    private static final Log log = LogFactory.getLog(AddOrCreateResearchDataToAgreementGenerator.class);

    public AddOrCreateResearchDataToAgreementGenerator() {
        super("http://purl.org/ands/ontologies/vivo/ResearchData",
                "Research Data",
                objectName,
                AddResearchDataToAgreementGenerator.class);
    }
