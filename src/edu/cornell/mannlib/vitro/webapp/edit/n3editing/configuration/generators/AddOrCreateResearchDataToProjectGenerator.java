 ...
 * @author tsullivan
 */
public class AddOrCreateResearchDataToProjectGenerator extends AddOrCreateGenerator {

    private static final String template = "addOrCreateResearchData.ftl";
    private static final String subjectName = "project";
    private static final String predicateName = "predicate";
    private static final String objectName = "researchDataUri";
    private static final Log log = LogFactory.getLog(AddOrCreateResearchDataToProjectGenerator.class);

    public AddOrCreateResearchDataToProjectGenerator() {
        super("http://purl.org/ands/ontologies/vivo/ResearchData", 
            "Research Data",
            objectName,
            AddResearchDataToProjectGenerator.class);
    }
