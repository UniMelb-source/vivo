...
/**
 * Custom form for adding a grant to an person for the predicates
 * hasCo-PrincipalInvestigatorRole and hasPrincipalInvestigatorRole.
 *
 * This is intended to create a set of statements like:
 *
 * ?person core:hasPrincipalInvestigatorRole ?newRole. ?newRole rdf:type
 * core:PrincipalInvestigatorRole ; core:relatedRole ?someGrant .  *
 *
 */
public class AddGrantRoleToPersonGenerator implements EditConfigurationGenerator {
    ...
    /**
     * Methods with default values that may be overwritten when required by a
     * subclass Both Default value and method that can be overwritten are
     * included below
	 *
     */
