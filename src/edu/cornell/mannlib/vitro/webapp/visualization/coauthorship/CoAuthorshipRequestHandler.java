...
/**
 * This request handler is used when information related to co-authorship
 * network for an individual is requested. It currently provides 2 outputs, 1.
 * Graphml content representing the individual's co-authorship network 1. CSV
 * file containing the list(& count) of unique co-authors with which the
 * individual has worked over the years. This data powers the related sparkline.
 *
 * @author cdtank
 */
public class CoAuthorshipRequestHandler implements VisualizationRequestHandler {
    ...
    /**
     * Provides response when a csv file containing number & names of unique
     * co-authors per year is requested.
     *
    ...
    /**
     * Provides a response when graphml formatted co-authorship network is
     * requested, typically by the flash vis.
     *
     * @param authorNodesAndEdges
     * @param response
     */
