...
/**
 * This request handler is used when you need helpful information to add more
 * context to the visualization. It does not have any code for generating the
 * visualization, just fires sparql queries to get info for specific cases like,
 * 1. thumbnail/image location for a particular individual 2. profile
 * information for a particular individual like label, moniker etc 3. person
 * level vis url for a particular individual etc.
 *
 * @author cdtank
 */
