...
/**
 * This request handler is used to serve content rendered on the person level
 * vis page like, 1. Front end of the vis including the co-author & publication
 * sparkline. 2. Downloadable file having the co-author network in graphml
 * format. 3. Downloadable file having the list of co-authors that the
 * individual has worked with & count of such co-authorships.
 *
 * @author cdtank
 */
